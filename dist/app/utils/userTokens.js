...
const createNewAccessTokenWithRefreshToken = (refeshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const verifiedRefreshToken = (0, jwt_1.verifyToken)(refeshToken, env_1.envVars.JWT_REFRESH_SECRET);
