...
router.patch("/:id", (0, checkAuth_1.checkAuth)(user_interface_1.Role.ADMIN, user_interface_1.Role.SUPER_ADMIN), (0, validateRequest_1.validateRequest)(tour_validation_1.updateTourZodSchema), multer_config_1.multerUpload.array("files"), tour_controller_1.TourController.updateTour);
